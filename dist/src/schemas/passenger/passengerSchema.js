...
exports.updatePassengerSchema = joi_1.default.object({
    ...
    homeAddress: joi_1.default.string().trim().messages({
        "string.trim": "Home address must be a string",
    }),
    homeLat: joi_1.default.number().messages({
        "number.base": "Home latitude must be a number",
    }),
    homeLong: joi_1.default.number().messages({
        "number.base": "Home longitude must be a number",
    }),
