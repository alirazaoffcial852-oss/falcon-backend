...
const swaggerDocument = {
    ...
    info: {
        title: "Falcon API",
        version: "1.0.0",
        description: "API docs for Falcon backend. Use Authorize to set Bearer token (from POST /f1/auth/login). All admin routes require admin role.",
    },
    servers: [
        ...
        schemas: {
            ...
            RegisterBody: {
                ...
                properties: {
                    ...
                    adminSecret: {
                        type: "string",
                        description: "Required when creating admin and DB already has users. Set ADMIN_REGISTER_SECRET in env.",
                    },
                },
            },
            // Company
    ...
    paths: {
        ...
        "/f1/auth/register": {
            post: {
                tags: ["Auth"],
                summary: "Register",
                description: "Create a new user (admin, driver, or passenger). First user can be admin without adminSecret. After that, creating admin requires adminSecret matching ADMIN_REGISTER_SECRET.",
                security: [],
                requestBody: {
                    required: true,
                    content: {
        ...
        "/f1/auth/login": {
            post: {
                tags: ["Auth"],
                summary: "Login",
                description: "Login with email/password. Use returned token as Bearer token for protected routes.",
                security: [],
                requestBody: {
                    required: true,
                    content: {
        ...
        "/f1/auth/forgot-password/request-otp": {
            post: {
                ...
                description: "Request a forgot password OTP to be sent to the email address.",
                security: [],
                requestBody: {
                    required: true,
                    content: {
        ...
        "/f1/auth/forgot-password/verify-otp": {
            post: {
                ...
                description: "Verify the forgot password OTP sent to the email address.",
                security: [],
                requestBody: {
                    required: true,
                    content: {
        ...
        "/f1/uploads/image": {
            post: {
                ...
                description: "Common image upload endpoint. Sends file to Cloudinary and returns URL + public_id. Use the returned URL in other APIs (driver, car, etc.).",
                security: [{ bearerAuth: [] }],
                requestBody: {
                    required: true,
                    content: {
                                    ...
                                    properties: {
                                        ...
                                        data: {
                                            ...
                                            properties: {
                                                url: {
                                                    type: "string",
                                                    example: "https://res.cloudinary.com/your-cloud/image/upload/v123/driver_image-1.jpg",
                                                },
                                                public_id: {
                                                    type: "string",
        ...
        "/f1/drivers": {
            ...
            post: {
                ...
                description: "Creates driver and linked user account. Email is required; a random 6-8 digit temporary password is sent to that email.",
                security: [{ bearerAuth: [] }],
                requestBody: {
                    required: true,
                    content: {
        ...
        "/f1/passengers": {
            ...
            post: {
                ...
                description: "Creates passenger and linked user account. Email is required; a random 6-8 digit temporary password is sent to that email.",
                security: [{ bearerAuth: [] }],
                requestBody: {
                    required: true,
                    content: {
